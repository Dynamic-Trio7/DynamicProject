package hello.football.domain.member;
...
public class MemberRepository {
    ...
    public Member save(Member member) {
        ...
        String sql = "insert into member(id,loginID, password,name,gender,description) values(?,?,?,?,?,?)";
    ...
    public void update(String id, Member member) {
        String sql = "update member set description=? , name=? where id=?";
        Connection con = null;
        PreparedStatement pstmt = null;
        ...
        try {
            con = getConnection();
            pstmt = con.prepareStatement(sql);
            pstmt.setString(1, member.getDescription());
